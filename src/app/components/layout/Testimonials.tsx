...
const ScrollingColumn = ({ 
  ...
  return (
    <div 
      className="w-96 h-full overflow-hidden"
      ...
      <section className="bg-[#141414] py-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex justify-center gap-8 relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-[#141414] via-transparent via-transparent to-[#141414] pointer-events-none z-10 h-full"></div>
            <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#141414] to-transparent pointer-events-none z-20"></div>
            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#141414] to-transparent pointer-events-none z-20"></div>
            
            <div className="flex gap-8 h-[600px] overflow-hidden relative">
              <ScrollingColumn 
