...
//   microDetails = ["Low‑weight font", "Tight tracking", "Subtle motion"]
  ...
  return (
    <section ref={sectionRef} className="absolute h-screen w-screen z-[999]">
      <ShaderBackground />

      <div className="absolute mx-auto flex max-w-9xl flex-col items-start gap-6 px-6 pb-24 pt-36 -z-[999] sm:gap-8 sm:pt-44  ">
