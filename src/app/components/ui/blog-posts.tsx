...
export const BlogPosts = ({
  ...
  return (
    <div className="bg-gradient-to-t from-[#141414] to-[#141414]/80">

    <section className={cn(
      "container relative mb-20 py-10 mx-auto px-4",
      className
    )}>
      <h1 className="text-center text-4xl font-semibold text-white capitalize !leading-[1.4] md:text-5xl lg:text-6xl mb-2">
        {title}
      </h1>
      ...
      {backgroundLabel && (
        <span
          className={cn(
            "absolute -top-10 -z-50 select-none text-[180px] text-white/70 font-extrabold leading-[1]  md:text-[250px] lg:text-[400px] text-foreground/[0.095]",
      ...
      <p className="mx-auto max-w-[800px] text-center text-xl !leading-[2] text-white/70 md:text-2xl mb-8">
        {description}
      </p>
      ...
      <div className="grid h-auto grid-cols-1 gap-5 md:h-[650px] md:grid-cols-2 lg:grid-cols-[1fr_0.5fr]">
        {posts.map((post, index) => {
          ...
          return (
            ...
            >
              <div className="absolute inset-0 -z-0 h-[130%] w-full bg-gradient-to-t from-black to-transparent transition-all duration-500 group-hover:h-full" />
